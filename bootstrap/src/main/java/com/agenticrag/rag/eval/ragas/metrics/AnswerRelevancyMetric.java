...
public class AnswerRelevancyMetric {
    ...
    public double calculate(String question, String answer, AiRuntimeContext context, String userId) {
        ...
        try {
            ...
            log.error("Answer relevancy metric calculation failed: {}", e.getMessage());
            return -1.0;
        }
    }
