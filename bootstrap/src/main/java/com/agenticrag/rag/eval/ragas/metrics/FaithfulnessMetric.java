...
public class FaithfulnessMetric {
    ...
    public double calculate(String question, String answer, List<String> contexts, AiRuntimeContext context, String userId) {
        ...
        try {
            ...
            log.error("Faithfulness metric calculation failed: {}", e.getMessage());
            return -1.0;
        }
    }
